...
<div>
    ...
    <div style ="text-align: center; margin: 0 auto">
        <h1 class="md-headline" style="color: white;">Registro</h1>
    </div>
    ...
    <div  style="margin-top:2em;margin-left: 10.25%;margin-right: 10.25% ">
        ...
        <form id="userForm" @submit="checkForm">
                    ...
                    <md-list style="font-size:14px; margin: 10px;">
                        ...
                        <md-list-item>
                            <md-field>
                                ...
                                <md-input id="profile_name" placeholder="Nombre y Apellidos"></md-input>
                        ...
                        <md-list-item>
                            <md-field>
                                ...
                                <md-input id="profile_phone" placeholder="666555444"></md-input>
            ...
            <div style="text-align: center;">
              ...
              <a class="md-button" style="text-transform: initial; color:grey">Ya tengo una cuenta</a>
            </div>
          </div>        
    </div>
        <!--Fin datos-->
